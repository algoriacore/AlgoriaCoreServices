...
namespace AlgoriaCore.Application.Tests.Host.Roles
{
    [Collection("TestsCollection")]
    public class RolesTests : TestBaseHost
    {
        ...
        {
            Role entity = Context.Role.FirstOrDefault(p => p.TenantId == SessionContext.TenantId && p.Name.ToUpper() == "ADMIN");
