...
namespace AlgoriaCore.Application.Tests.Host.Users
{
    [Collection("TestsCollection")]
    public class UsersTests : TestBaseHost
    {
        ...
        public async Task UpdateUserTest()
        {
            ...
            long response = await Mediator.Send(new UserUpdateCommand()
            {
                ...
                LastName = "Apellido P prueb",
                SecondLastName = "Apellido M prueba",
                EmailAddress = "correoupd@dominio.com",
                PhoneNumber = "3515345",
                UserName = "UPD",
                //Password = "contrasenia",
                ShouldChangePasswordOnNextLogin = true,
		...
		public async Task ResetUserPasswordTest()
		{
			...
			{
				TenancyName = SessionContext.TenancyName,
