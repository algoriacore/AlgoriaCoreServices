...
{
    public class ChatRoomGetOrCreateCommandValidator : AbstractValidator<ChatRoomGetOrCreateCommand>
    {
        private readonly ICoreServices _coreServices;

        public ChatRoomGetOrCreateCommandValidator(ICoreServices coreServices)
        {
