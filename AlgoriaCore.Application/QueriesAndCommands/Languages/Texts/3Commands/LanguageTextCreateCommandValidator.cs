...
{
    public class LanguageTextCreateCommandValidator : AbstractValidator<LanguageTextCreateCommand>
    {
        private readonly ICoreServices _coreServices;

        public LanguageTextCreateCommandValidator(ICoreServices coreServices)
        {
