...
{
    public class LanguageTextGetForEditValidator : AbstractValidator<LanguageTextGetForEditQuery>
    {
        private readonly ICoreServices _coreServices;

        public LanguageTextGetForEditValidator(ICoreServices coreServices)
        {
