...
{
    public class MailGroupUpdateCommandValidator : AbstractValidator<MailGroupUpdateCommand>
    {
        private readonly ICoreServices _coreServices;

        public MailGroupUpdateCommandValidator(ICoreServices coreServices)
        {
