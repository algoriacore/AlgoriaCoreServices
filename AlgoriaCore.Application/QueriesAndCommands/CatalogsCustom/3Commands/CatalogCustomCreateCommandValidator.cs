...
{
    public class CatalogCustomCreateCommandValidator : AbstractValidator<CatalogCustomCreateCommand>
    {
        private readonly ICoreServices _coreServices;

        public CatalogCustomCreateCommandValidator(ICoreServices coreServices)
        {
