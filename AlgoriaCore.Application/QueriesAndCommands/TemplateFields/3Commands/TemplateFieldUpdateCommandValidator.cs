...
{
    public class TemplateFieldUpdateCommandValidator : AbstractValidator<TemplateFieldUpdateCommand>
    {
        private readonly ICoreServices _coreServices;

        public TemplateFieldUpdateCommandValidator(ICoreServices coreServices)
        {
