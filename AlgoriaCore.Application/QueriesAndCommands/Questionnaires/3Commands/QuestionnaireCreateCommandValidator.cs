...
{
    public class QuestionnaireCreateCommandValidator : AbstractValidator<QuestionnaireCreateCommand>
    {
        private readonly ICoreServices _coreServices;

        public QuestionnaireCreateCommandValidator(ICoreServices coreServices)
        {
