...
{
    public class TemplateSectionCreateCommandValidator : AbstractValidator<TemplateSectionCreateCommand>
    {
        private readonly ICoreServices _coreServices;

        public TemplateSectionCreateCommandValidator(ICoreServices coreServices)
        {
