...
{
    public class TemplateSectionGetByIdValidator : AbstractValidator<TemplateSectionGetByIdQuery>
    {
        private readonly ICoreServices _coreServices;

        public TemplateSectionGetByIdValidator(ICoreServices coreServices)
        {
