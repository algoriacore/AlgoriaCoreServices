...
{
    public class TemplateSectionGetForEditValidator : AbstractValidator<TemplateSectionGetForEditQuery>
    {
        private readonly ICoreServices _coreServices;

        public TemplateSectionGetForEditValidator(ICoreServices coreServices)
        {
