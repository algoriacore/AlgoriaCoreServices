...
{
    public class HostSettingsGetForEditQueryHandler : BaseCoreClass, IRequestHandler<HostSettingsGetForEditQuery, HostSettingsForEditResponse>
    {
        private readonly SettingManager _managerSetting;

        public HostSettingsGetForEditQueryHandler(
        ...
        public async Task<HostSettingsForEditResponse> Handle(HostSettingsGetForEditQuery request, CancellationToken cancellationToken)
        {
            HostSettingsDto dto = await _managerSetting.GetAllHostSettings();

            return new HostSettingsForEditResponse()
            {
                WebSiteRootAddress = dto.WebSiteRootAddress,
                PasswordUseDefaultConfiguration = dto.PasswordUseDefaultConfiguration,
                PasswordComplexity = new HostSettingsPasswordComplexityResponse()
                {
                ...
                PasswordComplexityDefault = new HostSettingsPasswordComplexityResponse()
                {
                ...
                EnableTwoFactorLogin = dto.EnableTwoFactorLogin,
                EnableMailVerification = dto.EnableMailVerification,
                EnableSMSVerification = dto.EnableSMSVerification,
                EnableBrowserRemenberMe = dto.EnableBrowserRemenberMe,
                ...
                GrpcEmail = new HostGrpcEmailResponse
                {
